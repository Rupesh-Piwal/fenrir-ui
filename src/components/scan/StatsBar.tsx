...
export const StatsBar = () => {
  return (
    <div
      className="bg-surface border-t border-border flex items-center px-6 py-3 text-xs text-text-secondary w-full justify-between"
      role="status"
      aria-label="Scan statistics"
    >
      <div className="hidden md:flex items-center gap-8">
        <div className="flex items-center gap-2">
          <div className="w-1.5 h-1.5 rounded-full bg-text-secondary" aria-hidden="true"></div>
